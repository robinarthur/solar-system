...
def terminator(ox, oy, rad, angle, col):
    if ox + rad > 0 and ox - rad < xSize:
        if rad < 2:
            angle = 180 - abs(180 - angle)/2
            circle(screen,[col[0]*angle/180,col[1]*angle/180,col[2]*angle/180],(ox-1,oy),rad)
        else:
            ...
            for y in range(oy - rad, oy + rad):
                ...
                try:
                    ...
                    horizontal_line.fill((0, 0, 0, 243))
...
add_body("Spaceship",[255,255,255],[255,255,255],"",100,[0,600],0,0)
